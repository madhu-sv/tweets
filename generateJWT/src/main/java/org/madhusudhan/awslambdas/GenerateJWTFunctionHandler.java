...
public class GenerateJWTFunctionHandler implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
	
	private static final String SECRET_NAME = System.getenv("SECRET_NAME"); //Replace with the secret name or make it a config property
	...
	public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent input, Context context) {
		...
		if (userDetailsCache.containsKey(userName) && 
				(password.equals(userDetailsCache.get(userName)))) {
			try {

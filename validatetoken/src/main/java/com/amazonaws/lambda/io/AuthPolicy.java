 ...
 * AWS policy for the API Gateway authoriser. The constructor receives the calling
...
public class AuthPolicy {
    ...
    /**
     * IAM Policies use capitalised field names, but Lambda by default will serialize object members using camel case
     *
     ...
     * in the context of a API Gateway Authoriser
     *
     * Initialise the PolicyDocument with
    ...
    public static class PolicyDocument {
         ...
         * and initialises two base Statement objects for allowing and denying access to API Gateway methods
         *

 ...
 * AWS policy for the API Gateway authoriser. The constructor receives the
...
public class AuthPolicy {
	...
	/**
	 * IAM Policies use capitalised field names, but Lambda by default will
	 ...
	 * execute-api:Invoke action in the context of a API Gateway Authoriser
	 *
	 * Initialise the PolicyDocument with the region where the RestApi is
	...
	public static class PolicyDocument {
		...
		/**
		 * Creates a new PolicyDocument with the given context, and initialises two base
		 ...
		 * @param stage        and the Stage on the RestApi that the Policy will apply
		 *                     to
		 */
